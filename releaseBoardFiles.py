...
Run from the organisation root folder (or any repo root).
Finds all jlcpcb/production_files/ folders recursively, copies BOM/CPL/GERBER files
to the correct repo's releases/ folder, then removes the jlcpcb/ folder.
"""
